...
(function() {
    ...
    Placeholder.create(['id', 'templateId', 'templateName', 'placeholderIndex', 'resourceType']);
    ...
    PagePlaceholder.create(['id', 'pageId', 'placeholderId', 'placeholderIndex', 'resourceType', 'groupId', 'groupName', 'detailConfig']);
